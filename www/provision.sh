...
if [ ! -f /opt/femiwiki-provisioned ]; then
    ...
    ## CodeMirror
    sudo git clone --recurse-submodules --depth 1 https://gerrit.wikimedia.org/r/p/mediawiki/extensions/CodeMirror \
        -b REL1_31 /var/www/femiwiki.com/extensions/CodeMirror
    sudo /etc/composer/composer.phar update --no-dev -d /var/www/femiwiki.com/extensions/CodeMirror
